...
avisar_whatsapp(){
  ...
  MENSAJE="✅ INSTALACION PHENIX-M&M 2.0%0A%0A🔹 IP: $IP%0A🔹 CLAVE: $LIC%0A🔹 ESTADO: LISTO Y ACTIVO"
...
echo "DROPBEAR_PORT=90" > /etc/default/dropbear
...
echo -e "=====================================================\033[0m"
echo -e "  ESCRIBA: \033[1;37mmenu\033[1;32m  PARA ABRIR EL PANEL PRINCIPAL"
echo -e "\033[1;32m=====================================================\033[0m"
