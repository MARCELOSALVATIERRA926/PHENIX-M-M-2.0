...
avisar_whatsapp(){
  ...
  MENSAJE="✅ INSTALACION PHENIX-M&M 2.0%0A%0A🔹 IP: $IP%0A🔹 CLAVE: $LIC%0A🔹 ESTADO: INSTALADO - CONFIGURAR DESDE EL MENU"
...
# ==============================================
# ESTRUCTURA E INSTALACION LIMPIA
# ==============================================
...
echo -e "\033[1;34m>>> DESCARGANDO ARCHIVOS DEL SISTEMA...\033[0m"
mkdir -p ${SCPinstal}
...
echo -e "=====================================================\033[0m"
echo -e "  TODOS LOS ARCHIVOS ESTAN LISTOS"
